...
const splitViewModule = require('splitView.js')
splitViewModule.initialize(require('webviews.js'))
require('splitViewDivider.js').initialize(splitViewModule)
...
require('promptModal.js').initialize()
require('browserControlRenderer.js').initialize()
...
require('sidebar.js').initialize()
require('workspaceDrawer/workspaceDrawer.js').initialize()
